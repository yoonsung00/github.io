...
|Num|화면||용어|설명|
|:----:|:----:|:----:|:----:|:----:|
||Index(시작화면)|||Diver 게임 시작 시 첫 화면, 시작하기, 설정이 있다.|
||Index(시작화면)|화면요소|타이틀|게임의 타이틀인 'Diver'|
||Index(시작화면)|화면요소|시작하기 버튼|클릭 시 게임화면으로 이동한다.|
||Index(시작화면)|화면요소|설정하기 버튼|클릭 시 설정 창으로 이동한다.|
||Setting(설정화면)|게임 설정 화면|||
||Setting(설정화면)|화면요소|음향 설정|사운드 바를 이용하여 게임 음향 설정이 가능하다.|
||Setting(설정화면)|화면요소|뒤로가기 버튼|클릭 시 시작화면으로 이동한다.|
||Setting(설정화면)|스크립트 요소|AudioListener|Controls the game sound volume (0.0 to 1.0).|
||Setting(설정화면)|스크립트 요소|audio|AudioMixer에서 지정한 값|
||Setting(설정화면)|스크립트 요소|volume|0부터 1까지 소리 크기를 조절한다.|
||Play(게임화면)|||인게임 화면이다. 스크렉 섹션, Boss 정보 섹션이 있다.|
||Play(게임화면)|화면요소|사망 횟수|화면 우측 위에 사망 횟수 text가 있다.|
||Play(게임화면)|화면요소|Stage 정보|화면 우측 위에 현재 Stage를 알리는 text가 있다.|
||Play(게임화면)|화면요소|Boss 체력 바|화면 중앙 위에 Boss의 체력 바가 있다.|
||Play(게임화면)|화면요소|키 설명|게임에서 사용하는 키를 설명해 놓은 목록이다.|
||Play(게임화면)|화면요소|SavePoint|게임 진행에 따라 현재 위치를 저장하는 박스이다.|
||Play(게임화면)|화면요소|플레이어|게임에서 조작하는 플레이어 캐릭터이다.|
||Play(게임화면)|화면요소|몬스터|플레이어를 방해하는 몬스터이다.|
||Play(게임화면)|화면요소|트랩|플레이어가 닿으면 사망하는 트랩이다.|
||Play(게임화면)|화면요소|블록|플레이어가 이동 할 수 있는 박스이다.|
||Play(게임화면)|화면요소|다시하기|‘R’를 누르면 다시하기가 가능하다는 text이다.|
||Play(게임화면)|스크립트 요소|LEFT|왼쪽 이동 방향키이다. 코드 37|
||Play(게임화면)|스크립트 요소|RIGHT|오른쪽 이동 방향키이다. 코드 39|
||Play(게임화면)|스크립트 요소|ESC|ESC키 코드 27.|
||Play(게임화면)|스크립트 요소|Z|Z키(위로 점프) 코드 122|
||Play(게임화면)|스크립트 요소|X|X키(공격) 코드 120|
||Play(게임화면)|스크립트 요소|R|R키(다시시작) 코드 114|
||Play(게임화면)|스크립트 요소|Text_Death|사망 횟수를 저장하는 배열이다.|
||Play(게임화면)|스크립트 요소|Text_Stage|현재 Stage 정보를 저장하는 배열이다.|
||Play(게임화면)|스크립트 요소|Boss1_HP|1 스테이지 보스의 체력이다. int|
||Play(게임화면)|스크립트 요소|Boss2_HP|2 스테이지 보스의 체력이다. int|
||Play(게임화면)|스크립트 요소|Boss3_HP|3 스테이지 보스의 체력이다. int|
||Play(게임화면)|스크립트 요소|Boss4_HP|4 스테이지 보스의 체력이다. int|
||Play(게임화면)|스크립트 요소|Boss5_HP|5 스테이지 보스의 체력이다. int|
||Play(게임화면)|스크립트 요소|Savepoint|현재 위치를 저장하는 데이터이다.|
||Play(게임화면)|스크립트 요소|GameBgm|인게임에서 출력되는 배경음악|
||Play(게임화면)|스크립트 요소|Jump_Count|점프 횟수 카운트 (2회 점프시 더 못하도록한다)|
||Play(게임화면)|스크립트 요소|Jump_Item|점프 1회 가능한 아이템을 저장하는 오브젝트 변수이다.|
||Play(게임화면)|스크립트 요소|Boss1_Attack|1 스테이지 보스의 기본 공격력을 저장하는 변수이다. int|
||Play(게임화면)|스크립트 요소|Boss2_Attack|2 스테이지 보스의 기본 공격력을 저장하는 변수이다. int|
||Play(게임화면)|스크립트 요소|Boss3_Attack|3 스테이지 보스의 기본 공격력을 저장하는 변수이다. int|
||Play(게임화면)|스크립트 요소|Boss4_Attack|4 스테이지 보스의 기본 공격력을 저장하는 변수이다. int|
||Play(게임화면)|스크립트 요소|Boss5_Attack|5 스테이지 보스의 기본 공격력을 저장하는 변수이다. int|
||Play(게임화면)|스크립트 요소|Boss1_PA1|1 스테이지 보스의 패턴1 공격을 저장하는 변수이다.|
||Play(게임화면)|스크립트 요소|Boss1_PA2|1 스테이지 보스의 패턴2 공격을 저장하는 변수이다.|
||Play(게임화면)|스크립트 요소|Boss2_PA1|2 스테이지 보스의 패턴1 공격을 저장하는 변수이다.|
||Play(게임화면)|스크립트 요소|Boss2_PA2|2 스테이지 보스의 패턴2 공격을 저장하는 변수이다.|
||Play(게임화면)|스크립트 요소|Boss3_PA1|3 스테이지 보스의 패턴1 공격을 저장하는 변수이다.|
||Play(게임화면)|스크립트 요소|Boss3_PA2|3 스테이지 보스의 패턴2 공격을 저장하는 변수이다.|
||Play(게임화면)|스크립트 요소|Boss4_PA1|4 스테이지 보스의 패턴1 공격을 저장하는 변수이다.|
||Play(게임화면)|스크립트 요소|Boss4_PA2|4 스테이지 보스의 패턴2 공격을 저장하는 변수이다.|
||Play(게임화면)|스크립트 요소|Boss5_PA1|5 스테이지 보스의 패턴1 공격을 저장하는 변수이다.|
||Play(게임화면)|스크립트 요소|Boss5_PA2|5 스테이지 보스의 패턴2 공격을 저장하는 변수이다.|
||Play(게임화면)|스크립트 요소|Boss1_RA|1 스테이지 보스의 랜덤 공격을 저장하는 변수이다.|
||Play(게임화면)|스크립트 요소|Boss2_RA|2 스테이지 보스의 랜덤 공격을 저장하는 변수이다.|
||Play(게임화면)|스크립트 요소|Boss3_RA|3 스테이지 보스의 랜덤 공격을 저장하는 변수이다.|
||Play(게임화면)|스크립트 요소|Boss4_RA|4 스테이지 보스의 랜덤 공격을 저장하는 변수이다.|
||Play(게임화면)|스크립트 요소|Boss5_RA|5 스테이지 보스의 랜덤 공격을 저장하는 변수이다.|
||Play(게임화면)|스크립트 요소|Trap|트랩과 충돌 시 사망하도록 저장하는 변수이다.|
||Play(게임화면)|스크립트 요소|MovingTrap|움직이는 트랩 값을 저장하는 위치값 배열이다.|
||Play(게임화면)|스크립트 요소|isPlay|play일때 true, pause일때 false 값인 play, pause의 값.|
||Play(게임화면)|스크립트 요소|state|게임의 상태를 저장한 배열이다. |
||Play(게임화면)|스크립트 요소|Block|플레이어가 이동 가능한 블록 배열이다.|
||Play(게임화면)|스크립트 요소|MovingBlock|움직이는 블록 값을 저장하는 배열이다.|
||Play(게임화면)|스크립트 요소|Monster2|2 스테이지 몬스터 이동값을 저장하는 변수이다.|
||Play(게임화면)|스크립트 요소|Monster3|3 스테이지 몬스터 이동값을 저장하는 변수이다.|
||Play(게임화면)|스크립트 요소|Monster4|4 스테이지 몬스터 이동값을 저장하는 변수이다.|
||Play(게임화면)|스크립트 요소|Monster5|5 스테이지 몬스터 이동값을 저장하는 변수이다.|
<br>
